...
function CategoryItem({ category }) {
  ...
  return (
    <a href={"#" + href} className="w-full">
      <div className="flex flex-col flex-none w-[140px] h-[200px] md:w-full md:h-[110px]  px-1 py-2 text-center text-white md:flex-row md:px-2 bg-black/20 rounded-xl">
